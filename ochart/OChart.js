/**
 * Organization chart tree component
 *
 * @author Evandro Bitencourt
 */
Ext.define('Ext.ux.ochart.OChart',{
    ...
    expandTip: 'Click here to expand/collapse this item.',
    ...
    afterRender: function(){
        ...
        me.expandTool = Ext.create('Ext.Component',{
            ...
            autoEl: {
               tag: 'div',
               'data-qtip': Ext.util.Format.htmlEncode(me.expandTip)
            },
            shadow: false,
            hidden: true,
            width: 16,
    ...
    getSelectionModel: function(){
        ...
        if (!me.selModel || !me.selModel.events) {
            me.selModel = new Ext.ux.ochart.OChartModel(Ext.apply({
